# CraftLogic: Crochet (prototype)
# pattern_generator.py

def ask_menu_choice(prompt: str, valid_choices: tuple):
    """
    Generic menu input helper.
    Returns the choice, or 'back' if user enters 'b'.
    """
    while True:
        ...
        if choice in valid_choices:
            return choice
        print(f"Please choose {', '.join(valid_choices)} or 'b' to go back.\n")
...
def is_nav(value: str) -> bool:
    return value in ("__BACK__", "__QUIT__")

pattern_style = "beginner"  # "beginner" or "advanced"
DEFAULT_UNIT = "in"         # industry standard
...
def print_granny_blanket_plan(blanket_w_in: float, blanket_h_in: float, blanket_label: str,
                              square_in: float, border: dict, finished_includes_border: bool):
    ...
    # Adjust blanket body size depending on border inclusion choice
